  ...
  <script>
    ...
    export default {
      ...
      methods: {
        ...
        getLocalData() {
          let userName1 = window.localStorage.getItem("userName1");
          let userName2 = window.localStorage.getItem("userName2"); // added username2
          ...
          if (userName1 === null || userName2 === null || playerStats === null || openings === null || archivedGames === null) {
            return null;
          } else {
            return {
              userName1: userName1,
              userName2: userName2, // added username2
